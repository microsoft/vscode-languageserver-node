...
function _createMessageConnection(
    ...
    let requestHandlers: {
        [name: string]: RequestHandlerElement | undefined;
    } = Object.create(null);
    let starNotificationHandler: StarNotificationHandler | undefined = undefined;
    let notificationHandlers: {
        [name: string]: NotificationHandlerElement | undefined;
    } = Object.create(null);
    ...
    let requestTokens: {
        [id: string]: CancellationTokenSource;
    } = Object.create(null);
    ...
    let errorEmitter: Emitter<[Error, Message | undefined, number | undefined]> = new Emitter<
    ...
    function traceReceivedResponse(message: ResponseMessage, responsePromise: ResponsePromise): void {
        ...
        if (responsePromise) {
            ...
            tracer.log(
                `Received response '${responsePromise.method} - (${message.id})' in ${Date.now() -
