...
describe('Connection', () => {
    ...
    it('Test Duplex Stream Connection', done => {
        ...
        let connection = hostConnection.createMessageConnection(
            duplexStream1,
            duplexStream2,
    ...
    it('Unhandled Request', done => {
        ...
        let client = hostConnection.createMessageConnection(duplexStream1, duplexStream2, hostConnection.NullLogger);
        client.listen();
        client.sendRequest(type, 'foo').then(
            _result => {},
    ...
    it('N params in request / response', done => {
        ...
        let client = hostConnection.createMessageConnection(duplexStream1, duplexStream2, hostConnection.NullLogger);
        client.listen();
        client.sendRequest(type, 10, 20, 30).then(
            result => {
    ...
    it('N params in request / response with token', done => {
        ...
        client.listen();
        client.sendRequest(type, 10, 20, 30, token).then(
            result => {
                assert.strictEqual(result, 60);
                done();
            },
    ...
    it('Untyped request / response', done => {
        ...
        let token = new CancellationTokenSource().token;
        client.listen();
        client.sendRequest('test', 10, 20, 30, token).then(
            result => {
                assert.strictEqual(result, 60);
                done();
            },
    ...
    it('Cancellation token is undefined', done => {
        ...
        let client = hostConnection.createMessageConnection(duplexStream1, duplexStream2, hostConnection.NullLogger);
        client.listen();
        client.sendRequest(type, 10, 20, 30, undefined).then(
            result => {
                assert.strictEqual(result, 60);
                done();
            },
    ...
    it('Missing params in request', done => {
        ...
        let client = hostConnection.createMessageConnection(duplexStream1, duplexStream2, hostConnection.NullLogger);
        client.listen();
        (client.sendRequest as Function)(type, 10, 20).then(
            (result: any) => {
