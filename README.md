...
- remove `null` from the `textDocument/documentColor` and `textDocument/colorPresentation` request to make it consistent with the specification. This is a breaking change.
