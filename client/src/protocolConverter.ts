...
export interface Converter {
    ...
    asCompletionResult(
        result: ls.CompletionItem[] | ls.CompletionList | undefined | null
    ): code.CompletionItem[] | code.CompletionList | undefined;
...
export function createConverter(uriConverter?: URIConverter): Converter {
    ...
    function asDiagnostic(diagnostic: ls.Diagnostic): code.Diagnostic {
        let result = new code.Diagnostic(
    ...
    ): code.DiagnosticRelatedInformation[] {
        return relatedInformation.map(asDiagnosticRelatedInformation);
    }

    function asDiagnosticRelatedInformation(
        information: ls.DiagnosticRelatedInformation
    ): code.DiagnosticRelatedInformation {
    ...
    ): code.MarkdownString | code.MarkdownString[] {
        if (Is.string(value)) {
    ...
    ): [code.CompletionItemKind, ls.CompletionItemKind | undefined] {
