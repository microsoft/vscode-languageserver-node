...
suite('Protocol Converter', () => {
    ...
    test('Diagnostic Severity', () => {
        ...
        strictEqual(
            p2c.asDiagnosticSeverity(proto.DiagnosticSeverity.Information),
    ...
    test('Document Highlight Kind', () => {
        strictEqual(
            p2c.asDocumentHighlightKind(<any>proto.DocumentHighlightKind.Text),
            vscode.DocumentHighlightKind.Text
        );
        strictEqual(
            p2c.asDocumentHighlightKind(<any>proto.DocumentHighlightKind.Read),
            vscode.DocumentHighlightKind.Read
        );
        strictEqual(
            p2c.asDocumentHighlightKind(<any>proto.DocumentHighlightKind.Write),
    ...
    test('WorkspaceEdit', () => {
        ...
        let change1 = workspaceChange.getTextEditChange({
            uri: uri1,
            version: 1,
        });
        change1.insert(proto.Position.create(0, 1), 'insert');
        let uri2 = 'file:///xyz.txt';
        let change2 = workspaceChange.getTextEditChange({
            uri: uri2,
            version: 99,
        });
...
suite('Code Converter', () => {
    ...
    test('Text Edit Replace', () => {
        let replace = vscode.TextEdit.replace(
            new vscode.Range(new vscode.Position(1, 2), new vscode.Position(8, 9)),
            'insert'
        );
    ...
    test('DiagnosticSeverity', () => {
        ...
        strictEqual(
            c2p.asDiagnosticSeverity(<any>vscode.DiagnosticSeverity.Information),
    ...
    test('Diagnostic', () => {
        let item: vscode.Diagnostic = new vscode.Diagnostic(
            new vscode.Range(1, 2, 8, 9),
            'message',
    ...
    test('CodeActionContext', () => {
        let item: vscode.CodeActionContext = {
            diagnostics: [
                new vscode.Diagnostic(new vscode.Range(1, 2, 8, 9), 'message', vscode.DiagnosticSeverity.Warning),
            ],
        };
